...
\begin{itemize}
  ...
  \item From 0 to Kubernetes Eine Einführung zur Container-Orchestrierung mit praktischen Antworten auf die häufigsten Fragen wie ``warum?'' oder ``wann?''
  \item Congratulations, it's a Kubernetes! But now what?
  \item Hilfe, ich bin Manager - und jetzt? Oder auch: Wie man in der IT Karriere machen kann
\end{itemize}
