...
\begin{itemize}
  \cvitem{Backend API Development}{Developed and optimised high-performance GoLang APIs, integrating with AWS services and AWS Athena to support scalable data processing.}
